...
#define GREENWORKS_VERSION                                                                                                                                     \
  GREENWORKS_STRINGIFY(GREENWORKS_MAJOR_VERSION) "." GREENWORKS_STRINGIFY(GREENWORKS_MINOR_VERSION) "." GREENWORKS_STRINGIFY(GREENWORKS_PATCH_VERSION)
