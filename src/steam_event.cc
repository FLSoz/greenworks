...
void SteamEvent::OnGameOverlayActivated(bool is_active) {
  ...
  v8::Local<v8::Value> argv[] = {Nan::New("game-overlay-activated").ToLocalChecked(), Nan::New(is_active)};
...
void SteamEvent::OnSteamServersConnected() {
  Nan::HandleScope scope;
  v8::Local<v8::Value> argv[] = {Nan::New("steam-servers-connected").ToLocalChecked()};
...
void SteamEvent::OnSteamServersDisconnected() {
  Nan::HandleScope scope;
  v8::Local<v8::Value> argv[] = {Nan::New("steam-servers-disconnected").ToLocalChecked()};
...
void SteamEvent::OnSteamServerConnectFailure(int status_code) {
  Nan::HandleScope scope;
  v8::Local<v8::Value> argv[] = {Nan::New("steam-server-connect-failure").ToLocalChecked(), Nan::New(status_code)};
...
void SteamEvent::OnPersonaStateChange(uint64 raw_steam_id, int persona_change_flag) {
  Nan::HandleScope scope;
  v8::Local<v8::Value> argv[] = {
      Nan::New("persona-state-change").ToLocalChecked(),
      greenworks::SteamID::Create(raw_steam_id),
      Nan::New(persona_change_flag),
  };
...
void SteamEvent::OnAvatarImageLoaded(uint64 raw_steam_id, int image_handle, int height, int width) {
  Nan::HandleScope scope;
  v8::Local<v8::Value> argv[] = {
      Nan::New("avatar-image-loaded").ToLocalChecked(), greenworks::SteamID::Create(raw_steam_id), Nan::New(image_handle), Nan::New(height), Nan::New(width),
  };
...
void SteamEvent::OnGameConnectedFriendChatMessage(uint64 raw_steam_id, int message_id) {
  Nan::HandleScope scope;
  v8::Local<v8::Value> argv[] = {
...
void SteamEvent::OnMicroTxnAuthorizationResponse(uint32 AppID, uint64 OrderID, bool Autorized) {
  Nan::HandleScope scope;
  v8::Local<v8::Value> argv[] = {
...
void SteamEvent::OnLobbyCreated(int status_code, uint64 SteamIdLobby) {
  Nan::HandleScope scope;
  v8::Local<v8::Value> argv[] = {Nan::New("lobby-created").ToLocalChecked(), Nan::New(status_code),
...
void SteamEvent::OnLobbyEnter(uint64 SteamIdLobby, int ChatPermissions, bool Locked, int ChatRoomEnterResponse) {
  Nan::HandleScope scope;
  v8::Local<v8::Value> argv[] = {
      Nan::New("lobby-enter").ToLocalChecked(), Nan::New(utils::uint64ToString(SteamIdLobby)).ToLocalChecked(), Nan::New(ChatPermissions), Nan::New(Locked),
...
void SteamEvent::OnLobbyInvite(uint64 SteamIdUser, uint64 SteamIdLobby, uint64 GameId) {
  Nan::HandleScope scope;
  v8::Local<v8::Value> argv[] = {Nan::New("lobby-invite").ToLocalChecked(), Nan::New(utils::uint64ToString(SteamIdUser)).ToLocalChecked(),
                                 Nan::New(utils::uint64ToString(SteamIdLobby)).ToLocalChecked(), Nan::New(utils::uint64ToString(GameId)).ToLocalChecked()};
...
void SteamEvent::OnGameLobbyJoinRequested(uint64 SteamIdLobby, uint64 SteamIdUser) {
  Nan::HandleScope scope;
  v8::Local<v8::Value> argv[] = {Nan::New("lobby-join-requested").ToLocalChecked(), Nan::New(utils::uint64ToString(SteamIdLobby)).ToLocalChecked(),
...
void SteamEvent::OnGameRichPresenceJoinRequested(uint64 steamIDFriend, std::string rgchConnect) {
  Nan::HandleScope scope;
  v8::Local<v8::Value> argv[] = {Nan::New("rich-presence-join-requested").ToLocalChecked(), Nan::New(utils::uint64ToString(steamIDFriend)).ToLocalChecked(),
...
void SteamEvent::OnNewUrlLaunchParameters() {
  Nan::HandleScope scope;
  v8::Local<v8::Value> argv[] = {Nan::New("new-url-launch-parameters").ToLocalChecked()};
