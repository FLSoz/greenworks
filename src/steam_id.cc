...
v8::Local<v8::Object> SteamID::Create(CSteamID steam_id) {
  ...
  SetPrototypeMethod(tpl, "isAnonymousGameServerLogin", IsAnonymousGameServerLogin);
  ...
  SetPrototypeMethod(tpl, "isPersistentGameServerAccount", IsPersistentGameServerAccount);
  ...
  v8::Local<v8::Object> instance = Nan::NewInstance(Nan::GetFunction(tpl).ToLocalChecked()).ToLocalChecked();
  Nan::SetInternalFieldPointer(instance, 0, obj);
  return scope.Escape(instance);
}

NAN_METHOD(SteamID::IsAnonymous) {
  auto* obj = ObjectWrap::Unwrap<SteamID>(info.This());
